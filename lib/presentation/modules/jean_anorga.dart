...
class JeanAnorga extends StatelessWidget {
  const JeanAnorga({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            children: const [
              ...
              Text(""), //Espacio
              CircleAvatar(
                backgroundImage: AssetImage('assets/images/Jean.jpeg'),
                radius: 70,
              ),
              sizedBox15,

              Text('Jean Anorga', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
              Text(""), //Espacio
              Text('{Panda}', style: TextStyle(fontSize: 30, color: Color.fromARGB(255, 146, 146, 146), fontWeight: FontWeight.bold)),
              sizedBox10,
              Text(""), //Espacio
              //Espacio
              Text(

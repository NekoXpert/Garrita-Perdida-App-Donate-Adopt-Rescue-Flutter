...
class ReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'REPORTAR GARRITA',
      theme: ThemeData(primarySwatch: Colors.deepOrange, fontFamily: 'Montserrat'),
      home: const HomePage(),
    );
  }
}
          ...
          children: [
            ...
            Text('REPORTADOS',
                style: TextStyle(
                    ...
                    color: Color.fromARGB(255, 247, 68, 68))),
